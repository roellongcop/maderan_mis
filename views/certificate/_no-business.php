	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2 justify">
			...
			<p class="ti-50">
				...
				This is to certify that <b class="underline"><?= $model->people->fullname ?></b>, legal age, resident of 
				...
				This is to further certify that the aforementioned name has no registered / nor existing business as per record in this Barangay.
			</p>
